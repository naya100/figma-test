  ...
  var workSheet = {
      ...
      makeHead: function() {
         ...
         // $headerHtml += '<h1><span class="offscreen">KB기업뱅킹</span></h1>';
          ...
          $headerHtml += '<ul>';
          $headerHtml += '<li><a href="/msbiz/guide/html/worksheet.html" target="_blank">Worksheet</a></li>';
          $headerHtml += '<li><a href="/msbiz/guide/html/guide.html" target="_blank">Guide</a></li>';
          $headerHtml += '<li><a href="/msbiz/guide/html/document.html" target="_blank">Document</a></li>';
          $headerHtml += '</ul>';
          $headerHtml += '</div>';
          ...
          if (location.host == 'zmsbiz.kbstar.com' || location.host == 'zobiz.kbstar.com' || location.host =='ztadmin.kbstar.com' || location.host =='zmnbank.kbstar.com') {
              $headerHtml += '<li><a href="https://zmsbiz.kbstar.com/msbiz/guide/html/worksheet.html" target="_blank">App</a></li>';
          } else {  
              $headerHtml += '<li><a href="/msbiz/guide/html/worksheet.html" target="_blank">App</a></li>';
          }
